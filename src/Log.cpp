...
std::string warningPrefix = "Advertencia: ";
std::string debugPrefix   = "Debug:   ";
std::string verbosePrefix = "Notificiacion: ";
...
void Log::debugMode(bool option)
{
	...
	isDebugMode = true;
	Log::debug(">Modo de depuracion activo");
}
void Log::verboseMode(bool option)
{
	...
	// Prints a nice logo
	isVerboseMode = true;
	Log::verbose(">Modo de notificaciones activo");
}
void Log::clearLine()
{
	std::cout << clear_line;
